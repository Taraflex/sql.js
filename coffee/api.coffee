...
sqlite3_prepare_v2_sqlptr = null
...
sqlite3_create_function_v2 = null
sqlite3_value_type = null
sqlite3_value_bytes = null
sqlite3_value_text = null
sqlite3_value_int = null
sqlite3_value_blob = null
sqlite3_value_double = null
...
Module['init'] = () -> if listeners then new Promise((resolve) -> listeners.push resolve) else Promise.resolve(Module['Database'])